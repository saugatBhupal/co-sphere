class ApiEndpoints {
  ...
  static const String getExploreJobs = "$baseUrl/job/explore/";
  static const String applyToJob = "$baseUrl/job/apply";
  static const String createdJobs = "$baseUrl/job/user/";
