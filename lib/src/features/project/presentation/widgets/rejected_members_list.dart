...
import 'package:cosphere/src/features/project/presentation/widgets/card/rejected_members_card.dart';
import 'package:flutter/material.dart';

class RejectedMemberList extends StatelessWidget {
  final List<Applicants> applicants;
  final String projectId;
  const RejectedMemberList({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        DashboardTitle(
          title: "${AppStrings.rejected} (${applicants.length})",
        ...
        SizedBox(
          child: ListView.separated(
            ...
            itemBuilder: (context, index) => RejectedMembersCard(
